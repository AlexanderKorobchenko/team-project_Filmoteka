...
//     page.addEventListener('click', megaFunction);
// })

//       onWritesPageNumbers();


// function onWritesPageNumbers() {
//     // записывает номера страниц в кнопки
...
// function onChangeButtons() {
//      if (pagesTotal === clearButton) {            
//         for (let i = getsPageNumber(); i <= pagesTotal; i++) {
//               pagesEl[i].textContent = i;
//         }            
//     }
...
//     if (pagesTotal > clearButton) {
//         for (let i = getsPageNumber(); i <= clearButton-2; i++) {
//             pagesEl[i].textContent = i;
//             pagesEl[clearButton-1].textContent = '...';
//             pagesEl[clearButton].textContent = pagesTotal;
//         }
...
// function getsPageNumber(e) {// получает номер страницы для fetch запроса
    
//   let pageNumber = Number(e.target.textContent);//надо отправить в fetch, получить новый массив и зарендерить
